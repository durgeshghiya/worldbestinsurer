        ...
        <div className="mb-10">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-surface rounded-xl border border-border p-5 space-y-3">
              ...
              {insurer.contact.phone && insurer.contact.phone !== insurer.contact.customerCareNumber && (
                <div className="flex items-center gap-3">
                  <Phone className="w-4 h-4 text-text-tertiary shrink-0" />
                  <div className="min-w-0">
                    <p className="text-[11px] text-text-tertiary">Phone</p>
                    <div className="flex items-center gap-1">
                      <a href={`tel:${insurer.contact.phone.replace(/\s/g, "")}`} className="text-[14px] text-text-primary hover:text-primary transition-colors">
                        {insurer.contact.phone}
                      </a>
                      <CopyButton text={insurer.contact.phone} />
                    </div>
                  </div>
                </div>
              )}
